                        ...
                        if (event == "telemetry") {
                            ...
                            for (size_t i = 0; i < sensor_fusion.size(); ++i) {
                                ...
                                if (is_in_lane(vehicle.d, lane)) {
                                    ...
                                    vehicle.s += (double) prev_size * 0.02 *
                                                 vehicle.speed; // use previous points to project s value onward
                            ...
                            vector<double> next_wp0 = get_cartesian(car_s + 30, (lane_width * lane + lane_width / 2),
                                                                    map_waypoints_s, map_waypoints_x, map_waypoints_y);
                            vector<double> next_wp1 = get_cartesian(car_s + 60, (lane_width * lane + lane_width / 2),
                                                                    map_waypoints_s, map_waypoints_x, map_waypoints_y);
                            vector<double> next_wp2 = get_cartesian(car_s + 90, (lane_width * lane + lane_width / 2),
                                                                    map_waypoints_s, map_waypoints_x, map_waypoints_y);
